    ...
    >
      ...
      <div className="sidebar-body">
        <div className="sidebar-menu">
          <ul className="menu-list">
            <li className="menu-item">
              <Link to="/teacher" className="menu-link active">
            ...
            <li className="menu-item">
              <Link to="/teacher/classes" className="menu-link">
                <span className="menu-link-icon">
            ...
            <li className="menu-item">
              <Link to="/teacher/attendence" className="menu-link">
                <span className="menu-link-icon">
            ...
            <li className="menu-item">
              <Link to="/teacher/assignments" className="menu-link">
                <span className="menu-link-icon">
            ...
            <li className="menu-item">
              <Link to="/teacher/resources" className="menu-link">
                <span className="menu-link-icon">
                  <GrResources size={20} />
                </span>
            ...
            <li className="menu-item">
              <Link to="/teacher/meetings" className="menu-link">
                <span className="menu-link-icon">
        ...
        <div className="sidebar-menu sidebar-menu2">
          <ul className="menu-list">
            <li className="menu-item">
              <Link to="/teacher/settings" className="menu-link">
                <span className="menu-link-icon">
